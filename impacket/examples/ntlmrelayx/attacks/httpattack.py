...
from impacket.examples.ntlmrelayx.attacks.httpattacks.ewsattack import EWSAttack

PROTOCOL_ATTACK_CLASS = "HTTPAttack"


class HTTPAttack(ProtocolAttack, ADCSAttack, EWSAttack):
    """

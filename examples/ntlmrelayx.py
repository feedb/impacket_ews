...
def start_servers(options, threads):
    for server in RELAY_SERVERS:
        ...
        c.setIsEWSAttack(options.ews)    
        c.setEWSOptions(options.folder)   
...
if __name__ == '__main__':
    ...
    # EWS options
    ewsoptions = parser.add_argument_group("EWS attack options")
    ewsoptions.add_argument('--ews', action='store_true', required=False, help='Enable Exchange EWS relay attack')
    ewsoptions.add_argument('--folder', action='store', metavar="folder", required=False, help='folder to dump: inbox, sentitems, outbox ')
